...
def get_common_args():
    ...
    parser.add_argument('--blue_start_position', type=parse_nested_list, default=[[-5000,0,10000],[-4000,0,10000]],help='蓝方起始位置格式为JSON数组,例如：[[x1,y1,z1],[x2,y2,z2]]')
    parser.add_argument('--red_start_position', type=parse_nested_list, default=[[5000,0,10000],[4000,0,10000]],help='红方起始位置格式为JSON数组,例如：[[x1,y1,z1],[x2,y2,z2]]')
    parser.add_argument('--red_high_value_pisotion', type=parse_nested_list, default=[[5000,0,0],[4000,0,0]],help='红方高价值目标格式为JSON数组,例如：[[x1,y1,z1],[x2,y2,z2]]')
    parser.add_argument('--blue_start_angle', type=parse_nested_list, default=[[0,0,0],[0,0,0]],help='蓝方起始角度roll,pitch,yaw格式为JSON数组,例如：[[roll1,pitch1,yaw1],[roll2,pitch2,yaw2]]')
    parser.add_argument('--red_start_angle', type=parse_nested_list, default=[[0,0,180],[0,0,180]],help='红方起始角度roll,pitch,yaw格式为JSON数组,例如：[[roll1,pitch1,yaw1],[roll2,pitch2,yaw2]]')
    parser.add_argument('--blue_missile_count', type=int, default=2,help='蓝方导弹数量')
    parser.add_argument('--red_missile_count', type=int, default=2,help='红方导弹数量')
    parser.add_argument('--position_range', type=float, nargs=3,default=[0,0,0],help='位置随机范围')
